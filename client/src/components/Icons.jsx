...
export function CuemathLogo({ className = 'w-9 h-9' }) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      <rect width="40" height="40" rx="10" fill="#F5A623" />
      <path d="M12 20C12 15.58 15.58 12 20 12C24.42 12 28 15.58 28 20C28 24.42 24.42 28 20 28"
        stroke="white" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M20 28C17.24 28 15 25.76 15 23C15 20.24 17.24 18 20 18"
        stroke="white" strokeWidth="2.5" strokeLinecap="round" />
...
export function StopIcon({ className = 'w-[18px] h-[18px]' }) {
  return (
...
export function DownloadIcon({ className = 'w-[18px] h-[18px]' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
